      ...
      <div className="flex w-full justify-center pt-5 md:pt-20">
        <div className="flex w-full max-w-3xl flex-col items-center justify-center gap-10 p-4 text-center">
          <a
            ...
            rel="noreferrer"
          >
            <div className="group flex cursor-pointer items-center gap-3 rounded-full border border-neutral-700/50 bg-neutral-900/50 px-6 py-3 backdrop-blur-sm transition-all hover:border-neutral-600/50 hover:bg-neutral-800/50">
              <svg
          ...
          <div className="flex flex-col gap-4 text-lg md:flex-row">
            ...
            <Link href="/docs">
              <button className="w-56 cursor-pointer rounded-full border border-neutral-400/50 py-4">
                Read Docs
              </button>
            </Link>
          </div>
